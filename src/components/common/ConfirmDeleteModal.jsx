...
export function ConfirmDeleteModal({ isOpen, onClose, onConfirm, title = '' }) {
  useEffect(() => {
        ...
        <div className="p-6">
          ...
          <div className="flex items-center justify-end gap-3 pt-6 border-t border-gray-100 mt-6">
            ...
            <button
              type="button"
              onClick={onConfirm}
              className="px-5 py-2 text-sm font-semibold text-white bg-red-600 hover:bg-red-700 active:bg-red-800 rounded-full transition-colors cursor-pointer shadow-xs"
            >
              Delete
            </button>
          </div>
