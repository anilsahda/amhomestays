...
export function Navbar() {
  ...
  const navLinks = [
    ...
    { label: 'Amber Moon', href: '#amber-moon' },
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden border-t border-gray-100 bg-white px-4 pt-3 pb-6 shadow-xl">
          ...
          <div className="flex flex-col gap-2.5 pt-4 mt-2 border-t border-gray-100">
            <Button variant="black" size="md" className="w-full justify-center">
              Book Now
            </Button>
            <Button variant="orange" size="md" className="w-full justify-center">
              Request a Quote
            </Button>
          </div>
        </div>
